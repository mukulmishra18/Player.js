...
export class StorageController {
  ...
  putAttachment() {
    ...
    this._storageInstance.putAttachment(this._storageID, this._storageID, this._fileData)
      .push(function() {
  ...
  getAttachment({ start, end }) {
    ...
    this._storageInstance.getAttachment(this._storageID, this._storageID, { start, end })
      .push(function(data) {
